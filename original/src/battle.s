...
battle:
    ...
    .importzp MsgCounter, CharacterOffset, BossID, byte_59, EnemyPos, EnemyCount
...
loc_17A17D:
    lda Character1 + BATTLE::field_1E,Y
    ora #4
    sta Character1 + BATTLE::field_1E,Y
    tya
    clc
    adc #$20
    tay
...
@health_pp:
    ...
    lda AddrForJmp
    sta Character1 + BATTLE::field_10+1,X
    lda Pointer
...
loc_17A257:
    ...
    lda Pointer+1
    bpl loc_17A285
    lda Character1 + BATTLE::field_1E,X
    ora #1
    sta Character1 + BATTLE::field_1E,X
    ldy #0
...
sub_17A53F:
    ...
    ldy CharacterOffset
    bmi loc_17A559
    lda Character1 + BATTLE::field_10+1,Y
    and #6
    eor #6
    beq loc_17A559
    jsr sub_17A7DA
...
loc_17A623:
    ...
    tya
    ldy CharacterOffset
    sta Character1 + BATTLE::field_10,Y
    txa
    sta Character1 + BATTLE::Script,Y
...
loc_17A723:
    ...
    adc CharacterOffset
    tay
    lda Character1 + BATTLE::field_10,Y
    ldy CharacterOffset
    sta Character1 + BATTLE::Script,Y
    jsr sub_17AC23
    jsr script_high
...
sub_17AA67:
    .import byte_169FB2, byte_169FB4, unk_588, unk_589, unk_58A
...
sub_17ABC2:
.import stru_169FA7, stru_169F9D

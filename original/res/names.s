...
.export sOnyxHook, sLastWeapon, sRuler, sCashCard, sRedWeed, sBullhorn, sMap, sDebug
...
TravelList:     .byte 0
sFlightplanA:   .byte "FlightplanA", 0
sFlightplanB:   .byte "FlightplanB", 0
sFlightplanC:   .byte "FlightplanC", 0
sHint1:         .byte "Hint 1", 0
sHint2:         .byte "Hint 2", 0
sHint3:         .byte "Hint 3", 0
sRealRocket:    .byte "Real Rocket", 0
sTimeMachine:   .byte "TimeMachine", 0

.export LocalList, sMyHome, sPodunk, sMerrysville, sReindeer, sSpookane, sSnowman, sYoungtown, sEllay, sUnion

LocalList:      .byte 0
sMyHome:        .byte "MyHome", 0
sPodunk:        .byte "Podunk", 0
sMerrysville:   .byte "Merrysville", 0
sReindeer:      .byte "Reindeer", 0
sSpookane:      .byte "Spookane", 0
sSnowman:       .byte "Snowman", 0
sYoungtown:     .byte "Youngtown", 0
sEllay:         .byte "Ellay", 0
sUnion:         .byte "Union", 0
...
SpellList:      .byte 0
sTelepathy:     .byte "Telepathy", 0
sTeleport:      .byte "Teleport", 0
...
sSuprHealing:   .byte "SuprHealing", 0
                .byte "PSIShield ", $BB, 0 ; alpha
                .byte "PSIShield ", $BC, 0 ; beta
sPowerShield:   .byte "PowerShield", 0
sBrainShock:    .byte "BrainShock", 0
sBrainCyclon:   .byte "BrainCyclon", 0
sHypnosis:      .byte "Hypnosis", 0
sParalysis:     .byte "Paralysis", 0
sDarkness:      .byte "Darkness", 0
sPSIMagnet:     .byte "PSI-Magnet", 0
sShieldOff:     .byte "Shield-Off", 0
sPSIBlock:      .byte "PSI-Block", 0
sOffenseUp:     .byte "OffenseUp", 0
                .byte "DefenseUp ", $BB, 0 ; alpha
                .byte "DefenseUp ", $BC, 0 ; beta
sQuickUp:       .byte "QuickUp", 0
                .byte "Def.Down ", $BB , 0 ; alpha
                .byte "Def.Down ", $BC , 0 ; beta
s4thDSlip:      .byte "4th-D Slip", 0
...
sFaintd:        .byte "Faintd", 0
sStone:         .byte " Stone", 0
sParlzd:        .byte "Parlzd", 0
sAsleep:        .byte "Asleep", 0
sConfsd:        .byte "Confsd", 0
sPuzzld:        .byte "Puzzld", 0
sPoison:        .byte "Poison", 0
sCold:          .byte "  Cold", 0
...
EnemyNameList:  .byte 0
sBigWoodoh:     .byte "BigWoodoh", 0
sDragon:        .byte "Dragon", 0
sR7038:         .byte "R7038", 0
sElephant:      .byte "Elephant", 0
sBear:          .byte "Bear", 0
sBigFoot:       .byte "Big Foot", 0
sMadTruck:      .byte "Mad Truck", 0
sOldRobot:      .byte "Old Robot", 0
sMegaborg:      .byte "Megaborg", 0
sGargoyle:      .byte "Gargoyle", 0
sGabilan:       .byte "Gabilan", 0
sGorilla:       .byte "Gorilla", 0
sBison:         .byte "Bison", 0
sTiger:         .byte "Tiger", 0
sMadCar:        .byte "Mad Car", 0
sRaebYddet:     .byte "Raeb Yddet", 0
sMagicSnail:    .byte "Magic Snail", 0
sTitanees:      .byte "Titanees", 0
sGiegue:        .byte "Giegue", 0
sEagle:         .byte "Eagle", 0
sWolf:          .byte "Wolf", 0
sSeagull:       .byte "Seagull", 0
sAlligator:     .byte "Alligator", 0
sEnergyRobot:   .byte "EnergyRobot", 0
sTheFish:       .byte "The Fish", 0
sFugitive:      .byte "Fugitive", 0
sBBsBoss:       .byte "B.B.'s Boss", 0
sBarbot:        .byte "Barbot", 0
sNancy:         .byte "Nancy", 0
sStarman:       .byte "Starman", 0
sUllrich:       .byte "Ullrich", 0
sCerebrum:      .byte "Cerebrum", 0
sMook:          .byte "Mook", 0
sArmor:         .byte "Armor", 0
sWoodoh:        .byte "Woodoh", 0
sWally:         .byte "Wally", 0
sTheHippie:     .byte "The Hippie", 0
sBagLady:       .byte "Bag Lady", 0
sBBGang:        .byte "B.B. Gang", 0
sDrDistorto:    .byte "Dr.Distorto", 0
sGangZombie:    .byte "Gang Zombie", 0
sPseudoZombi:   .byte "PseudoZombi", 0
sCrow:          .byte "Crow", 0
sSnake:         .byte "Snake", 0
sHyena:         .byte "Hyena", 0
sCougar:        .byte "Cougar", 0
sCentipede:     .byte "Centipede", 0
sDustBall:      .byte "Dust Ball", 0
sFly:           .byte "Fly", 0
sSpider:        .byte "Spider", 0
sScorpion:      .byte "Scorpion", 0
sRope:          .byte "Rope", 0
sFireBall:      .byte "Fire Ball", 0
sWatcher:       .byte "Watcher", 0
sGroucho:       .byte "Groucho", 0
sGhost:         .byte "Ghost", 0
sLilSaucer:     .byte "Lil Saucer", 0
sMrBat:         .byte "Mr. Bat", 0
sStarmanJr:     .byte "Starman Jr.", 0
sSkunk:         .byte "Skunk", 0
sShroudley:     .byte "Shroudley", 0
sRat:           .byte "Rat", 0
sBomber:        .byte "Bomber", 0
sDoll:          .byte "Doll", 0
sLamp:          .byte "Lamp", 0
sBionicCenti:   .byte "BionicCenti", 0
sBionicScorp:   .byte "BionicScorp", 0
sRedSnake:      .byte "Red Snake", 0
sLoneWolf:      .byte "Lone Wolf", 0
sPolarBear:     .byte "Polar Bear", 0
sRattlesnake:   .byte "Rattlesnake", 0
sTarantula:     .byte "Tarantula", 0
sCrocodile:     .byte "Crocodile", 0
sBuffalo:       .byte "Buffalo", 0
sBionicBat:     .byte "Bionic Bat", 0
sStrayDog:      .byte "Stray Dog", 0
sPsychoCar:     .byte "Psycho Car", 0
sPsychoTruck:   .byte "PsychoTruck", 0
sManiacTruck:   .byte "ManiacTruck", 0
sAlarmGhost:    .byte "Alarm Ghost", 0
sFoureyes:      .byte "Foureyes", 0
sDadseyes:      .byte "Dadseyes", 0
sMomseyes:      .byte "Momseyes", 0
sSkyYddet:      .byte "Sky Yddet", 0
sGigaBorg:      .byte "Giga Borg", 0
sOmegaBorg:     .byte "Omega Borg", 0
sScrapper:      .byte "Scrapper", 0
sUltraBarbot:   .byte "UltraBarbot", 0
sOmegaSaucer:   .byte "OmegaSaucer", 0
sKelly:         .byte "Kelly", 0
sStarMiner:     .byte "Star Miner", 0
sSuperEnergy:   .byte "SuperEnergy", 0
sJuana:         .byte "Juana", 0
sBlueStarman:   .byte "BlueStarman", 0
sRockoyle:      .byte "Rockoyle", 0
sTitanian:      .byte "Titanian", 0
sOhMook:        .byte "Oh-Mook", 0
sZombie:        .byte "Zombie", 0
sNastyZombie:   .byte "NastyZombie", 0
sSilverWolf:    .byte "Silver Wolf", 0
sR7037:         .byte "R7037", 0
sGrizzlyBear:   .byte "GrizzlyBear", 0
sR7038XX:       .byte "R7038XX", 0
sLastStarman:   .byte "LastStarman", 0

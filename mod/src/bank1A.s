...
sub_1AA0B1:
    .import darken_palette, clear_oam_sprite, clear_nametables
...
loc_1AA252:
    ...
    set NMI_Data + NMI_DATA::NumOfChr, #7
    set NMI_Data + NMI_DATA::PPU_Addr+1, #$E9

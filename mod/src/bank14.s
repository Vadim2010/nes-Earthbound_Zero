...
loc_149641:
    set NMI_Data + NMI_DATA::NMI_ID, #WRITE_CHAR
...
stru_149A3D:
    .import stru_1599C0, stru_1599C4
    animation_sprite $86, 0, $F4, $76, 0, 0, stru_1599C0
    animation_sprite 6, 0, $E4, $76, 0, 0, stru_1599C4
...
oam_sprite:
    ...
    adc #$F
    tay
    set OAM_Cache + OAM_TILE::PosY+4, #$59
    clc
    tya
    adc NamePos
    asl A
    ...
    set OAM_Cache + OAM_TILE::TileID+4, #1
    set OAM_Cache + OAM_TILE::Attr+4, #0
    tya
    sta Column
    set Row, #$A
...
@intro_screens:
    ...
    set Pointer, #0
    set SpriteTable + ANIM_SPRITE::Tiles + $E0, #$10
    set SpriteTable + ANIM_SPRITE::TileID + $E0, #0
    sta SpriteTable + ANIM_SPRITE::ShiftX + $E0
    sta SpriteTable + ANIM_SPRITE::ShiftY + $E0
    set SpriteTable + ANIM_SPRITE::PosX + $E0, #88
    set SpriteTable + ANIM_SPRITE::PosY + $E0, #87

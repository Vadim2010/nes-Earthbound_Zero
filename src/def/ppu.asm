...
; PPU memory map
; Pattern table 0 $0000-$0FFF and modes
PATTERN00 = $0000               ; 1K and 2K
PATTERN01 = $0400               ; 1K
PATTERN02 = $0800               ; 1K and 2K
PATTERN03 = $0C00               ; 1K
; Pattern table 1 $1000-$1FFF and modes
PATTERN10 = $1000               ; 1K and 2K
PATTERN11 = $1400               ; 1K
PATTERN12 = $1800               ; 1K and 2K
PATTERN13 = $1C00               ; 1K
; Nametables $2000-$2FFF and $3000-$3EFF mirrors of $2000-$2EFF
NAMETABLE0 = $2000
NAMETABLE1 = $2400
NAMETABLE2 = $2800
NAMETABLE3 = $2C00
; Palettes $3F00-$3F1F and $3F20-$3FFF mirrors of $3F00-$3F1F
PALETTE = $3F00                ; Background palette
SPRITE_P = $3F10               ; Sprite palette
